...
call s:CreateMaps('nx', 'Comment',    'Comment', 'nn')
call s:CreateMaps('nx', 'Toggle',     'Toggle', 'n<space>')
call s:CreateMaps('nx', 'Minimal',    'Minimal', 'nm')
call s:CreateMaps('nx', 'Nested',     'Nested', 'nc')
call s:CreateMaps('n',  'ToEOL',      'To EOL', 'n$')
call s:CreateMaps('nx', 'Invert',     'Invert', 'ni')
call s:CreateMaps('nx', 'Sexy',       'Sexy', 'ns')
call s:CreateMaps('nx', 'Yank',       'Yank then comment', 'ny')
call s:CreateMaps('n',  'Append',     'Append', 'nA')
call s:CreateMaps('',   ':',          '-Sep-', '')
call s:CreateMaps('nx', 'AlignLeft',  'Left aligned', 'nl')
call s:CreateMaps('nx', 'AlignBoth',  'Left and right aligned', 'nb')
call s:CreateMaps('',   ':',          '-Sep2-', '')
call s:CreateMaps('nx', 'Uncomment',  'Uncomment', 'nu')
call s:CreateMaps('n',  'AltDelims',  'Switch Delimiters', 'na')
